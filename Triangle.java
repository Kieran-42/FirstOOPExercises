...
//	java.util.Arrays;
	...
	*/
	...
	private static double[] triangleCheckSideLengthsAndAngles(double[] sideLengths, double[] angleValues, boolean returnSideLengths){
		if(!Triangle.possibleTriangle(sideLengths, angleValues)){
			throw new RuntimeException("Invalid Triangle");
		}
		return returnSideLengths ? sideLengths : angleValues;
	}
	...
	public Triangle(double[] sideLengths, double[] angleValues) {
		...
		super(triangleCheckSideLengthsAndAngles(sideLengths, angleValues, true), triangleCheckSideLengthsAndAngles(sideLengths, angleValues, false));
